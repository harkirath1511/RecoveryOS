...
export function LandingPage() {
  return <main className="landing-page">
    ...
    <footer className="landing-footer"><Link className="landing-brand" href="/"><span><BrandLogo /></span>RecoveryOS</Link><span>PAYMENT RECOVERY, UNSTUCK.</span><Link href="/login">OPERATOR SIGN IN <Icon name="arrow" /></Link></footer>
  </main>;
}
